...
//        });
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //画背景白色圆环
        initPaint();
        float doughnutWidth = Math.min(width, height) / 2 * 0.5f;
...
//        int fontSize = 50;
        ...
        canvas.drawCircle(width / 2, height / 2, doughnutWidth, paint);
...
//        canvas.drawText((int) (currentValue / 360f * 100) + "%", width / 2, baseLine, paint);
        canvas.drawText("MSS", width / 2, baseLine, paint);
    }
